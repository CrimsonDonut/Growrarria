...
namespace Growrarria.Content.Items
{
    ...
    public class CosmicCape : ModItem
    {
        ...
        {
            var wingPlayer = player.GetModPlayer<CosmicCapePlayer>();
            wingPlayer.hasCosmicCape = true;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new TooltipLine(Mod, "WingsAbility2", "Double tap LEFT or RIGHT to perform a damaging cosmic phase dash"));
            tooltips.Add(new TooltipLine(Mod, "WingsAbility3", "The wearer can run super fast, and has total liquid movement immunity"));
        }

        public override void AddRecipes()
        {
            Recipe recipe = CreateRecipe();
            recipe.AddIngredient(ItemID.SafemanWings, 1);
